(function() {
  ...
  document.querySelector("#p0").addEventListener('tiaweb-componentupgraded', function() {
    this.MaterialProgress.setProgress(pr[0]);
  });
  document.querySelector("#p1").addEventListener('tiaweb-componentupgraded', function() {
    this.MaterialProgress.setProgress(pr[1]);
  });
  document.querySelector("#p2").addEventListener('tiaweb-componentupgraded', function() {
    this.MaterialProgress.setProgress(pr[2]);
  });
  document.querySelector("#p3").addEventListener('tiaweb-componentupgraded', function() {
    this.MaterialProgress.setProgress(pr[3]);
  });
  document.querySelector("#p4").addEventListener('tiaweb-componentupgraded', function() {
    this.MaterialProgress.setProgress(pr[4]);
  });

  $('.tiaweb-layout__content').addClass('scroll');
...
function tgl(s,tipe,pisah){
  ...
  $('[name="opt-layout-theme"]').on('change', function(){
    $('.tiaweb-layout').removeClass(theme_used);    
    $('.tiaweb-layout').addClass("tiaweb-layout__" + $(this).val());    
    theme_used = "tiaweb-layout__" + $(this).val();
  });

  var sidebar_color_used = "";
  $('[name="opt-layout-sidebar"]').on('change', function(){
    $('.tiaweb-layout').removeClass(sidebar_color_used);    
    $('.tiaweb-layout').addClass("tiaweb-layout__" + $(this).val());    
    sidebar_color_used = "tiaweb-layout__" + $(this).val();
  });
...
var skin_used = "";
  $('.btn-choose__skin').on('click', function(){
    ...
    for (var i = 0; i < check_color.length; i++) {
      for (var j = 0; j < bg_color.length; j++) {
        if (check_color[i] === "bg-"+bg_color[j]) {
          $('.tiaweb-layout').removeClass(skin_used);
          $('.tiaweb-layout').addClass("tiaweb-layout__"+ bg_color[j] +"-skin");
          skin_used = "tiaweb-layout__"+ bg_color[j] +"-skin";
        }
      }
    }
  });
    ...
    $('.x-badge__close').on('click', function(){
      $(this).parent('.tiaweb-list__item').remove();
    });
  ...
  /* ------------- index.html ----------------*/
	if (url === "index.html" || url === "" || url === "horizontal.html" || url === "expanded.html") {
		...
		$('#btn-demo_todoList').on('click', function(){
			...
			var a = "";
		    a+='<li class="tiaweb-list__item">';
		      a+='<span class="tiaweb-list__item-primary-content">'+ txt.val() +'</span>';
...
/*	   document.querySelector("#demo-report1").addEventListener('tiaweb-componentupgraded', function() {
			this.MaterialProgress.setProgress(pr[0]);
	    });
	   document.querySelector("#demo-report2").addEventListener('tiaweb-componentupgraded', function() {
			$(this).children('.progressbar.bar.bar1').addClass('tiaweb-color--pink');
			this.MaterialProgress.setProgress(pr[1]);
	    });
	   document.querySelector("#demo-report3").addEventListener('tiaweb-componentupgraded', function() {
			$(this).children('.progressbar.bar.bar1').addClass('tiaweb-color--orange-900');
			this.MaterialProgress.setProgress(pr[2]);
	    });
	   document.querySelector("#demo-report4").addEventListener('tiaweb-componentupgraded', function() {
			$(this).children('.progressbar.bar.bar1').addClass('tiaweb-color--blue');
			this.MaterialProgress.setProgress(pr[3]);
	    });
	   document.querySelector("#demo-report5").addEventListener('tiaweb-componentupgraded', function() {
			$(this).children('.progressbar.bar.bar1').addClass('tiaweb-color--grey-900');
			this.MaterialProgress.setProgress(pr[4]);
	    });
*/
  ...
  if (url === "colors.html") {
      ...
      var ab =""; 
        ...
        for (var i = 0; i < array.length; i++) {
          ab+='<div class="tiaweb-cell tiaweb-cell--4-col-phone tiaweb-cell--3-col-desktop">';
          ab+='<ul class="demo-colors">';
          for (var j = 1; j <= 9; j++) {
            ab+='<li class=" tiaweb-color--'+array[i]+'-'+ j * number+'" >.tiaweb-color--'+array[i]+'-'+ j * number+'</li>';
          }
          ab+='</ul>';
          ab+='</div>';
        }
        ...
        for (var i = 0; i < array.length; i++) {
          a+='<div class="tiaweb-cell tiaweb-cell--4-col-phone tiaweb-cell--3-col-desktop">';
          a+='<ul class="demo-colors">';
          for (var j = 1; j <= 9; j++) {
          a+='<li class=" tiaweb-color-text--'+array[i]+'-'+ j * number+'" >.tiaweb-color-text--'+array[i]+'-'+ j * number+'</li>';
          }
          a+='</ul>';
          a+='</div>';
        }
...
if (url === "form-elements.html") {
  ...
  if (url === "form-stepper.html") {
        $(function ()
        {
            ...
            $('.wizard .actions a').addClass('tiaweb-button tiaweb-button--raised tiaweb-js-button');
        });
  } /* end form-stepper */
  ...
  if (url === "datatables.html") {
    $('#example').DataTable({
      ...
      columnDefs: [
          {
              targets: [ 0, 1, 2 ],
              className: 'tiaweb-data-table__cell--non-numeric'
          }
      ]
    });
  } /*end datatables.html*/
